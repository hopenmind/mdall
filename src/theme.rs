//! Heimdall Design System - Nordic alchemical warm theme (light mode).
//! Derived from the gold/bronze logo palette. Single accent (#C9920A).
//! Dark theme (future): derive by inverting HSL lightness while preserving hue/saturation.

use eframe::egui::{self, Color32, Stroke, Rounding};

// ── Color tokens ─────────────────────────────────────────────────────────
pub const BG:           Color32 = Color32::from_rgb(250, 248, 244); // #FAF8F4 parchment
pub const SURFACE:      Color32 = Color32::WHITE;
pub const SURFACE_SOFT: Color32 = Color32::from_rgb(245, 241, 234); // #F5F1EA
pub const SURFACE_ALT:  Color32 = Color32::from_rgb(237, 230, 218); // #EDE6DA
pub const TEXT:         Color32 = Color32::from_rgb(42, 31, 15);    // #2A1F0F ink warm
pub const TEXT_2:       Color32 = Color32::from_rgb(107, 84, 64);   // #6B5440
pub const TEXT_MUTED:   Color32 = Color32::from_rgb(155, 136, 120); // #9B8878
pub const ACCENT:       Color32 = Color32::from_rgb(201, 146, 10);  // #C9920A gold
pub const ACCENT_HOVER: Color32 = Color32::from_rgb(176, 124, 8);   // #B07C08
pub const ACCENT_PALE:  Color32 = Color32::from_rgb(240, 223, 160); // #F0DFA0
pub const BORDER:       Color32 = Color32::from_rgb(224, 213, 196); // #E0D5C4
pub const SELECTION:    Color32 = Color32::from_rgb(240, 216, 120); // #F0D878
pub const DESKTOP:      Color32 = Color32::from_rgb(92, 74, 56);    // #5C4A38 warm dark wood
pub const EQ_BG:        Color32 = Color32::from_rgb(245, 240, 232); // equation bg
...
pub fn light_visuals() -> egui::Visuals {
    ...
    // ACCENT gold bg (#C9920A) + dark text (#2A1F0F) = contrast 4.9:1 (AA).
    // Do NOT use WHITE fg_stroke - white on pale gold is unreadable.
...
pub fn build_dark_visuals() -> egui::Visuals {
    ...
    // Selection - translucent gold (accent hue unchanged)
    v.selection.bg_fill = Color32::from_rgba_unmultiplied(201, 146, 10, 110);
    ...
    // Widgets - Active / Pressed - gold bg + dark ink (same as light, AA contrast)
    v.widgets.active.bg_fill   = ACCENT;
    v.widgets.active.bg_stroke = Stroke::new(1.5, ACCENT_HOVER);
    v.widgets.active.fg_stroke = Stroke::new(2.0, TEXT);
    v.widgets.active.rounding  = Rounding::same(5.0);
